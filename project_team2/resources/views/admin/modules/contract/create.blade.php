            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Insurance ID" name="insurance_id">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>EndDate</label>
                        <input type="text" class="form-control" placeholder="Enter EndDate" name="enddate">
                    </div>
                </div>
            </div>
