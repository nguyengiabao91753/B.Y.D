        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Rate</label>
                        <input type="text" class="form-control" placeholder="Enter rate" id="rate" name="rate" value="{{old('rate',$insurance->rate)}}">
                    </div>
                    
                    <div class="form-group">
                        <label>Price</label>
                        <input type="text" class="form-control" placeholder="Enter price" id="price" name="price" value="{{old('price',$insurance->price)}}">
                    </div>
