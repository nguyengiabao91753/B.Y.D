...
@push('css')
<link rel="stylesheet" href="{{asset('client/css/third-party-car-insurance-form.css')}}">
@endpush
...
<main class="main">
<!--================================================== Vector============================================== -->
        <div class="vector"> <img src="{{asset('client/img_1/third%20party%20insurence%20img.jpg')}}" alt=""></div>
<!-- ==================================================Heading==================================================== -->
            <h1 class="heading" > What is Third Party Car Insurence?</h1>
...
<!--====================================================== forth drop down =========================================================-->
        <div class="pkr"> <select name="" id="" style="width: 20rem; height: 3rem ; font-size: medium ; border-radius: 2rem;text-align: center;";>
            ...
            <option value="40M-Above">40M-Above</option>
        </select> 
         </div>
...
<div class="container">
    <div class="item1">
        <div class="btn1">
            <a href="third-party-car-insurance-form-1.html">NEXT</a>
        </div>
    </div>
</div> </div>
        </main>
